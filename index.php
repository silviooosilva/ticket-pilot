...
<body>
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <label>Repo:</label>
            <input type="text" id="repo" class="form-control" value="ticket-pilot" />
            ...
            <div class="modal-content">
                <form id="issueForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Assignees (separated by commas)</label>
                            <input type="text" class="form-control" id="issueAssignees" name="assignees" />
                        </div>
                        <div class="mb-3">
                            <label>Labels (separated by commas)</label>
            ...
            <tr><th>#</th><th>Title</th><th>Status</th><th>Assignees</th><th>Labels</th><th>Milestone</th><th>Actions</th></tr>
                ...
                if (Array.isArray(data)) {
                    ...
                    <td>
                        ...
                        <button class="btn btn-sm btn-danger" onclick="deleteIssue(${issue.number})">Remove</button>
